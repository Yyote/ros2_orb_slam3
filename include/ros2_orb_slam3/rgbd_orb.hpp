...
{   
    ...
    private:
        ...
        std::string home_dir = "";
        std::string packagePath = "workspaces/wheeltec_robot_ros2/src/ros2_orb_slam3/"; //! Change to match path to your workspace
        ...
        void DepthImg_callback(const sensor_msgs::msg::Image& msg); // Callback to process RGB image and semantic matrix sent by Python node
